//! Virtual Machine - A VM is an emulation of a computer. Popek and Goldberg originally defined it as
//! "an efficient, isolater duplicate of a real computer machine."
